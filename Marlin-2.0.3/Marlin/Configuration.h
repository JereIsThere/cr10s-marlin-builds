...
#define STRING_CONFIG_H_AUTHOR "Logistikmann" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "LeMashiene V1.6"
/*
Changelog

09-Jun-20; V1.2: Changed probe offsets and inverted z min
10-Jun-20; V1.3: Tested not working offsets
12-Jun-20; V1.4: increased minProbeEdge from 10mm to 15mm
13-Jun-20; V1.5: shortened start up jingle
13-Jun-20; V1.6: set grid points to 4x per axis
*/
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { (0-60), (0-15), 0 }
...
#define X_BED_SIZE 298 // Nozzle is at X4 when homed
...
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE + 22 // 15mm Extra space on the right end
#define Y_MAX_POS X_BED_SIZE + 5  // 4mm Extra space behind the bed
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_INSET      30     // (mm) Left, Front, Right, Back insets

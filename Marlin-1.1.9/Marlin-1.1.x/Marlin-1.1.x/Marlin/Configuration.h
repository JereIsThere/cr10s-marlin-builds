...
#define CUSTOM_MACHINE_NAME "mashiene V4.3"
/*
   mashiene Changelog:
   V1: Standards
   V2: first probe settings
   V2.1: improved settings
   V2.2: improved offsets
   V2.3: changed values of V2.2
   V2.4: experimented with different offsets
   V2.5: fixed problems V2.4 caused
   V3: added custom bootscreen
   V3.1: defined z_safe_homing
   V3.2: improved bootscreen, implemented safe homing
   V3.3: added software endstops as a menu item
   V4: Set up new bed level probe
   V4.1: enabled M84, set bed size to size of mirror
   V4.2: improved probe position
   V4.3: refined min_probe_edge
*/
...
#define RIGHT_PROBE_BED_POSITION (X_BED_SIZE - 22)
